...
// // const summaryItems = [
// //     { label: "ผู้ใช้งานทั้งหมด", count: 128, icon: <GroupIcon />, color: "#81c784" }, users_count 
// //     { label: "อำเภอ", count: 128, icon: <LocationCityIcon />, color: "#81c784" }, district_count
// //     { label: "เส้นทาง", count: 128, icon: <LocationCityIcon />, color: "#81c784" }, travel_count
// //     { label: "สถานที่ท่องเที่ยว", count: 45, icon: <PlaceIcon />, color: "#66bb6a" }, places_count
// //     { label: "ที่พัก/โฮมสเตย์", count: 20, icon: <HotelIcon />, color: "#4caf50" }, 
// //     { label: "ร้านอาหาร", count: 36, icon: <RestaurantIcon />, color: "#388e3c" },
// //     { label: "ร้านของที่ระลึก", count: 36, icon: <ShoppingBag />, color: "#388e3c" },
// //     { label: "ผลิตภัณฑ์ชุมชน", count: 36, icon: <LocalOffer />, color: "#388e3c" },
// // ];
...
//             setLoading(true);
//             try {
//                 const resDistrict = await axios.get("http://localhost:8080/get_dashboard", {
//                     headers: {
...
//                 setDashboardData(resDistrict.data);
//                 setSummaryItems(generateSummaryItems(resDistrict.data));
//             } catch (err) {
...
//     const generateSummaryItems = (dashboardData) => [
//         { label: "ผู้ใช้งานทั้งหมด", count: dashboardData.users_count, icon: <GroupIcon />, color: "#81c784" },
//         { label: "อำเภอ", count: dashboardData.district_count, icon: <LocationCityIcon />, color: "#81c784" },
//         { label: "เส้นทาง", count: dashboardData.travel_count, icon: <LocationCityIcon />, color: "#81c784" },
//         { label: "สถานที่ท่องเที่ยวทั้งหมด", count: dashboardData.places_count, icon: <PlaceIcon />, color: "#66bb6a" },
//         { label: "สถานที่ท่องเที่ยว", count: dashboardData.tourist_attraction_count, icon: <PlaceIcon />, color: "#66bb6a" },
//         { label: "ที่พัก/โฮมสเตย์", count: dashboardData.hotel_count, icon: <HotelIcon />, color: "#4caf50" }, // TODO: เชื่อมจริงภายหลัง
//         { label: "ร้านอาหาร", count: dashboardData.restaurant_count, icon: <RestaurantIcon />, color: "#388e3c" },  // TODO: example data
