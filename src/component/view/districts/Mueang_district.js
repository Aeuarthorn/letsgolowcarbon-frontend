...
function Mueang_district({ screenWidth, defaultTheme, id }) {
  ...
  const routes = [
    { id: 1, name: 'เส้นทางที่ 1 อำเภอเมือง', image: 'image1.jpg' },
    { id: 2, name: 'เส้นทางที่ 2 อำเภอเมือง', image: 'image2.jpg' },
    { id: 3, name: 'เส้นทางที่ 3 อำเภอเมือง', image: 'image3.jpg' }
  ];
      ...
      <Grid item xs={24}>
        ...
        >
          ...
          >
            ...
            >
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 12, sm: 12, md: 12 }}>
                {t('route_mueang', { returnObjects: true }).map((route, index) => (
                  <Grid
                    item
                    key={index}
                    xs={12}
...
export default Mueang_district